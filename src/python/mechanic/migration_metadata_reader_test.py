...
""")
    ...
    def testRecognizesFlags(self):
      ...
      self.assertEqual(metadata["mechanic-prop-True"], True)
      self.assertEqual(metadata["mechanic-prop-true"], True)
      self.assertEqual(metadata["mechanic-prop-False"], False)
      self.assertEqual(metadata["mechanic-prop-false"], False)
      self.assertEqual(metadata["mechanic-prop-int"], 123)
      self.assertEqual(metadata["mechanic-prop-sqstring"], "test")
      self.assertEqual(metadata["mechanic-prop-dqstring"], "test")
      self.assertEqual(metadata["mechanic-prop-doubleslash-comment"], "test")
